...
with st.sidebar:
    ...
    st.markdown(
        "1. **Mixed · Streak-dominant** — Streaks ≥ 0.75, Mixed > 0.103, Spotty ≤ 0.069\n"
        "2. **Mixed · Spotty-dominant** — Streaks ≤ 0.7191, Mixed ≥ 0.1827, Spotty > 0.048\n"
        "3. **Spotty** — Spotty ≥ 0.55\n"
        "4. **Streaks** — Streaks > 0.8692\n"
